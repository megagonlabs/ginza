        ...
        for t in doc:
            ...
            if upos_cond:
                if isinstance(upos_cond, str):
                    t.tag_ = upos_cond
                    continue
                t.tag_ = upos_cond.get(None, t.tag_)  # default tag
            ...
            if t.ent_iob_ in "BILU":
                xpos_cond = NE_SUW_XPOS_TO_LUW_XPOS.get(t.ent_type_)
                if xpos_cond:
                    if isinstance(xpos_cond, str):
                        t.tag_ = xpos_cond
                        continue
                    luw_xpos = xpos_cond.get(t.tag_)
                    if luw_xpos:
                        t.tag_ = luw_xpos
                        continue
                    t.tag_ = xpos_cond.get(None, t.tag_)
            luw_xpos = LUW_UPOS_TO_LUW_XPOS.get(t.pos_)
            if luw_xpos:
                t.tag_ = luw_xpos
        return doc
...
NE_SUW_XPOS_TO_LUW_XPOS = {
    "GPE": {"名詞-固有名詞-地名-国": "名詞-固有名詞-地名-国", None: "名詞-固有名詞-地名-一般"},
    "NORP": {None: "名詞-固有名詞-一般"},
    "ORG": {None: "名詞-固有名詞-一般"},
    "PERSON": {"名詞-固有名詞-人名-姓": "名詞-固有名詞-人名-姓", None: "名詞-固有名詞-人名-一般"},
    "PET_NAME": {None: "名詞-固有名詞-一般"},
    "TITLE_AFFIX": {"名詞-固有名詞-一般": "名詞-固有名詞-一般", None: "名詞-固有名詞-人名-一般"},
}
...
SUW_XPOS_TO_LUW_XPOS = {
    ...
    "動詞-非自立可能-カ行変格": {None: "動詞-一般-カ行変格"},
    "動詞-非自立可能-サ行変格": {None: "動詞-一般-サ行変格"},
    "動詞-非自立可能-上一段-ア行": {None: "動詞-一般-上一段-ア行"},
    "動詞-非自立可能-上一段-カ行": {None: "動詞-一般-上一段-カ行"},
    "動詞-非自立可能-上一段-ガ行": {None: "動詞-一般-上一段-ガ行"},
    "動詞-非自立可能-上一段-マ行": {None: "動詞-一般-上一段-マ行"},
    "動詞-非自立可能-下一段-ア行": {None: "動詞-一般-下一段-ア行"},
    "動詞-非自立可能-下一段-カ行": {None: "動詞-一般-下一段-カ行"},
    "動詞-非自立可能-下一段-ガ行": {None: "動詞-一般-下一段-ガ行"},
    "動詞-非自立可能-下一段-サ行": {None: "動詞-一般-下一段-サ行"},
    "動詞-非自立可能-下一段-マ行": {None: "動詞-一般-下一段-マ行"},
    "動詞-非自立可能-下一段-ラ行": {None: "動詞-一般-下一段-ラ行"},
    "動詞-非自立可能-五段-カ行": {None: "動詞-一般-五段-カ行"},
    "動詞-非自立可能-五段-サ行": {None: "動詞-一般-五段-サ行"},
    "動詞-非自立可能-五段-ラ行": {"AUX": {"やる": "助動詞-助動詞-ヤ", "なる": "助動詞-文語助動詞-ナリ-断定"}, None: "動詞-一般-五段-ラ行"},  # "VERB": {"ある": "動詞-一般-五段-ワア行"
    "動詞-非自立可能-五段-ワア行": {None: "動詞-一般-五段-ワア行"},
    "動詞-非自立可能-文語サ行変格": {None: "動詞-一般-文語サ行変格"},
    "動詞-非自立可能-文語ラ行変格": {None: "動詞-一般-文語ラ行変格"},
    "動詞-非自立可能-文語上一段-マ行": {None: "動詞-一般-文語上一段-マ行"},
    "動詞-非自立可能-文語下二段-タ行": {None: "動詞-一般-文語下二段-タ行"},
    "動詞-非自立可能-文語下二段-ラ行": {None: "動詞-一般-文語下二段-ラ行"},
    "動詞-非自立可能-文語四段-サ行": {None: "動詞-一般-文語四段-サ行"},
    "動詞-非自立可能-文語四段-ハ行": {None: "動詞-一般-文語四段-ハ行"},
    "動詞-非自立可能-文語四段-ラ行": {None: "動詞-一般-文語四段-ラ行"},
...
LAST_SUW_XPOS_TO_LUW_XPOS = {
    ...
    "動詞-非自立可能-五段-ラ行": {"SCONJ": "助動詞-五段-ラ行"},  # {"ある": "助動詞-五段-ラ行", "有る": "助動詞-五段-ラ行", "なる": "助動詞-五段-ラ行", None: "動詞-一般-五段-ラ行"}},
