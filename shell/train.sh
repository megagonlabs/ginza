...
python -m ja_ginza.train_ner       -b ${model_dir} -e ${ner_corpus}/dev/ ${ner_corpus}/train/ &>> $log
python -m ja_ginza.evaluate_ner    -b ${model_dir} ${ner_corpus}/test/ &>> $log
